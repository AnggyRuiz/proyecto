...
insert  into `juego`(`idJuego`,`cantidadParticipantes`,`fecha_Juego`) values (0,2,'2017/11/13'),(1,2,'2017/11/13'),(2,1,'2017/11/13'),(3,4,'2017/11/13'),(4,1,'2017/11/13'),(5,0,'2017/11/13'),(6,1,'2017/11/13'),(7,1,'2017/11/13'),(8,0,'2017/11/13'),(9,1,'2017/11/13'),(10,1,'2017/11/13'),(11,1,'2017/11/13'),(12,1,'2017/11/13'),(13,1,'2017/11/13'),(14,2,'2017/11/13'),(15,1,'2017/11/13'),(16,2,'2017/11/13'),(17,2,'2017/11/13'),(18,2,'2017/11/13'),(19,2,'2017/11/13'),(20,2,'2017/11/13'),(21,2,'2017/11/13'),(22,3,'2017/11/13'),(23,3,'2017/11/13'),(24,2,'2017/11/13'),(25,0,'2017/11/13'),(26,0,'2017/11/13'),(27,1,'2017/11/13'),(28,1,'2017/11/13'),(29,0,'2017/11/13'),(30,1,'2017/11/13'),(31,1,'2017/11/13'),(32,1,'2017/11/13'),(33,0,'2017/11/14'),(34,0,'2017/11/14'),(35,2,'2017/11/14'),(36,2,'2017/11/14'),(37,2,'2017/11/14'),(38,2,'2017/11/14'),(39,3,'2017/11/14'),(40,0,'2017/11/14'),(41,2,'2017/11/14'),(42,3,'2017/11/14'),(43,3,'2017/11/14'),(44,0,'2017/11/14'),(45,0,'2017/11/14'),(46,0,'2017/11/14'),(47,1,'2017/11/14'),(48,2,'2017/11/14'),(49,2,'2017/11/14'),(50,1,'2017/11/14'),(51,2,'2017/11/14'),(52,2,'2017/11/14'),(53,2,'2017/11/14'),(54,2,'2017/11/14'),(55,2,'2017/11/14'),(56,1,'2017/11/14'),(57,2,'2017/11/14'),(58,1,'2017/11/14'),(59,0,'2017/11/14');
...
CREATE TABLE `partida` (
  ...
  KEY `FK_partida` (`idJuego`),
  CONSTRAINT `FK_partida` FOREIGN KEY (`idJuego`) REFERENCES `juego` (`idJuego`),
  CONSTRAINT `partida_ibfk_1` FOREIGN KEY (`idResultado`) REFERENCES `resultado` (`idResultado`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

/*Data for the table `partida` */

insert  into `partida`(`idPartida`,`idResultado`,`pregunta1`,`pregunta2`,`pregunta3`,`pregunta4`,`pregunta5`,`pregunta6`,`pregunta7`,`pregunta8`,`pregunta9`,`pregunta10`,`idJuego`) values (4,4,'86','80','87','81','88','82','89','83','90','84',55),(5,6,'96','90','97','91','98','92','99','93','100','94',57),(6,7,'101','95','102','96','103','97','104','98','105','99',58);
...
insert  into `respuestamultiple`(`idRespuesta`,`idUsuario`,`idPregunta`,`idJuego`,`respuesta`,`correcta`) values (4,88,13,23,'1;4','1;4'),(6,88,5,23,'2;3;4','1;2'),(7,88,3,23,'2;4','1;2'),(8,88,12,23,'1;2','1;2'),(9,88,5,24,'1;3','1;2'),(10,88,3,24,'1;2','1;2'),(11,88,13,24,'1;2;3','1;4'),(12,88,9,24,'1;2','1;2'),(13,88,11,24,'1;2;4','1;2'),(14,88,10,25,'2;3','1;2'),(15,88,10,27,'2;3','1;2'),(16,88,4,28,'1;2','1;2'),(17,88,12,29,'2;3','1;2'),(18,88,13,32,'2;3','1;4'),(19,88,3,34,'3;4','1;2'),(20,88,7,34,'3;4','1;2'),(21,88,9,37,'','1;2'),(22,88,4,37,'','1;2'),(23,88,8,37,'','1;2'),(24,88,9,38,'3;4','1;2'),(25,88,4,38,'2;3','1;2'),(26,88,5,38,'2;3','1;2'),(27,88,11,39,'3;4','1;2'),(28,88,12,39,'2;3','1;2'),(29,88,5,39,'1;2','1;2'),(30,88,8,40,'1;2','1;2'),(31,88,12,40,'1;2','1;2'),(32,88,11,40,'1;2','1;2'),(33,88,10,40,'1;2','1;2'),(34,88,4,40,'3;4','1;2'),(35,88,11,41,'1;2','1;2'),(36,88,9,41,'1;2','1;2'),(37,88,6,42,'1;2','1;2'),(38,88,12,42,'1;2','1;2'),(39,88,3,42,'3;4','1;2'),(40,88,5,42,'1;2','1;2'),(41,88,9,42,'2;3','1;2'),(42,88,7,43,'1;2','1;2'),(43,88,10,43,'1;2','1;2'),(44,88,5,43,'1;3','1;2'),(45,88,9,43,'3;4','1;2'),(46,88,11,43,'1;3','1;2'),(47,88,9,47,'1;2','1;2'),(48,88,7,47,'1;2','1;2'),(49,88,6,47,'2;3','1;2'),(50,88,12,47,'2;3','1;2'),(51,88,11,47,'1;3','1;2'),(52,88,5,48,'1;2','1;2'),(53,88,11,48,'1;2','1;2'),(54,88,12,48,'1;2','1;2'),(55,88,6,48,'1;2','1;2'),(56,88,3,48,'1;2','1;2'),(57,88,9,49,'1;2','1;2'),(58,88,3,49,'1;2','1;2'),(59,88,13,49,'1;4','1;4'),(60,88,11,49,'1;2','1;2'),(61,88,7,49,'1;2','1;2'),(62,88,10,50,'1;2','1;2'),(63,88,12,50,'1;2','1;2'),(64,88,6,50,'1;2','1;2'),(65,88,3,50,'1;2','1;2'),(66,88,5,50,'3;4','1;2'),(67,88,8,51,'1;2','1;2'),(68,88,13,51,'1;2','1;4'),(69,88,5,51,'3;4','1;2'),(70,88,4,51,'2;3','1;2'),(71,88,11,51,'2;3','1;2'),(72,88,8,52,'1;2','1;2'),(73,88,10,52,'1;2','1;2'),(74,88,9,52,'1;2','1;2'),(75,88,7,52,'1;2','1;2'),(76,88,3,52,'3;4','1;2'),(77,88,8,53,'2;3','1;2'),(78,88,10,54,'1;2','1;2'),(79,88,5,54,'1;2','1;2'),(80,88,11,55,'1;2','1;2'),(81,88,13,55,'1;4','1;4'),(82,88,3,55,'1;2','1;2'),(83,88,6,55,'1;2','1;2'),(84,88,4,55,'1;4','1;2'),(85,88,12,56,'1;2','1;2'),(86,88,10,56,'1;2','1;2'),(87,88,4,56,'1;2','1;2'),(88,88,11,56,'1;2','1;2'),(89,88,5,56,'2;3','1;2'),(90,88,9,57,'1;2','1;2'),(91,88,7,57,'1;2','1;2'),(92,88,11,57,'1;2','1;2'),(93,88,12,57,'2;3','1;2'),(94,88,10,57,'2;3','1;2'),(95,88,10,58,'1;2','1;2'),(96,88,5,58,'1;2','1;2'),(97,88,7,58,'3;4','1;2'),(98,88,3,58,'1;3','1;2'),(99,88,4,58,'1;2','1;2'),(100,88,9,59,'','1;2');
...
insert  into `resultado`(`idResultado`,`idJuego`,`idUsuario`,`campo1`,`campo2`,`campo3`,`campo4`,`campo5`,`campo6`,`campo7`,`campo8`,`campo9`,`campo10`) values (1,50,88,'si','si','si','si','no','si','si','si','si','no'),(2,51,88,'no','si','si','no','no','no','si','no','si','no'),(3,52,88,'si','si','si','si','si','si','si','si','si','no'),(4,55,88,'si','si','si','si','si','si','si','si','si','no'),(5,56,88,'si','si','si','si','si','si','si','si','si','no'),(6,57,88,'si','si','si','si','si','si','si','no','no','no'),(7,58,88,'no','si','si','si','si','no','no','no','no','si');
...
CREATE TABLE `resumen` (
  ...
  KEY `idResultado` (`idResultado`),
  KEY `idUsuario` (`idUsuario`),
  CONSTRAINT `resumen_ibfk_1` FOREIGN KEY (`idPartida`) REFERENCES `partida` (`idPartida`),
  CONSTRAINT `resumen_ibfk_2` FOREIGN KEY (`idResultado`) REFERENCES `resultado` (`idResultado`),
  CONSTRAINT `resumen_ibfk_3` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`codigo`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

/*Data for the table `resumen` */

insert  into `resumen`(`idResumen`,`idPartida`,`idResultado`,`idUsuario`) values (1,5,6,88),(2,6,7,88);
